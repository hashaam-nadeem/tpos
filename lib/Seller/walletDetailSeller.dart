...
class WalletDetailSeller extends StatefulWidget {
  final title;
  const WalletDetailSeller({this.title});
  @override
  _WalletDetailSellerState createState() => _WalletDetailSellerState();
}

class _WalletDetailSellerState extends State<WalletDetailSeller> {
