...
class ConversationSeller extends StatefulWidget {
  @override
  _ConversationSellerState createState() => _ConversationSellerState();
}

class _ConversationSellerState extends State<ConversationSeller> {
  @override
