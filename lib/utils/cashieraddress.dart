...
class CashierAddress extends StatefulWidget {
  @override
  _BuyerAdressState createState() => _BuyerAdressState();
}

class _BuyerAdressState extends State<CashierAddress> {
  // String lat;
  // String long;
  var _selected;
  ...
  Widget addressList(int index) {
    return GestureDetector(
        ...
        child: Container(
          ...
          color: selectedAddress == index ? Colors.grey : Colors.white,
