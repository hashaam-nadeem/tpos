...
class CashierProductDetail extends StatefulWidget {
  @override
  _ItemDetailsState createState() => _ItemDetailsState();
}

class _ItemDetailsState extends State<CashierProductDetail> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            User.userData.marketPlaceModel.result[User.userData.index].imgList!=null?
             _itemPhotos()
            :
             User.userData.marketPlaceModel.result[User.userData.index].imagePath!=null?
             Image.network("${API.API_URL}${User.userData.marketPlaceModel.result[User.userData.index].imagePath}"
             ,
              height: 200,
                width: 200,
             )
    ...
    return Container(
      ...
      child: Scrollbar(
        child: ListView.builder(
          itemCount:  User.userData.marketPlaceModel.result[User.userData.index].imgList.length,
          scrollDirection: Axis.horizontal,
          itemBuilder: (context, index) {
            return Image.network("${API.API_URL}${User.userData.marketPlaceModel.result[User.userData.index].imgList[index].url}",
             // height: 200,
                //width: 150,
              );
            // return Container(
        ...
        children: <Widget>[
          Align(
              ...
              child: Container(
                  ...
                  child: Center(
                    child: 
                    User.userData.marketPlaceModel.result[User.userData.index].isDiscountPercentage==true
                   ?
                      Text(
                ...
                Row(
                  children: <Widget>[
                    Text(
                          ...
                          style: TextStyle(
                              decoration:User.userData.marketPlaceModel.result[User.userData.index].withDiscount==true? TextDecoration.lineThrough:TextDecoration.none,
    ...
    return Container(
      ...
      child: Column(
       ...
       Container(
                 width: MediaQuery.of(context).size.width,
                 height:
                 User.userData.marketPlaceModel.result[User.userData.index].feedback!=null?
                 MediaQuery.of(context).size.height*.25:
                 MediaQuery.of(context).size.height*.02
                 ,
                 child: ListView.builder
                (
                  itemCount: User.userData.marketPlaceModel.result[User.userData.index].feedback!=null?
                  User.userData.marketPlaceModel.result[User.userData.index].feedback.length
                  :0,
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                   ...
                   // _fiveStar(),
                    _fiveStar(User.userData.marketPlaceModel.result[User.userData.index].feedback[index].rate),
                    Text(
                ...
                Text("${User.userData.marketPlaceModel.result[User.userData.index].feedback[index].feedBack}"
                    ),
                // Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Text("${User.userData.marketPlaceModel.result[User.userData.index].specification}"),
          ),
          // _descriptionDetails(),
          // _descriptionDetails(),
          // _descriptionDetails(),
    ...
    return Container(
      ...
      child: ListView(
        children: <Widget>[
          ...
          Text("${User.userData.marketPlaceModel.result[User.userData.index].description}"),
          // _descriptionDetails(),
          // _descriptionDetails(),
          // _descriptionDetails(),
        ],
